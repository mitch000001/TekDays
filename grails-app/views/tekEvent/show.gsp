                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" style="text-align: left;" class="value">
                                ...
                                <g:each in="${tekEventInstance.sponsorships}" var="s">
                                    <li><g:link controller="sponsorship" action="show" id="${s.id}">${s.sponsor?.encodeAsHTML()}</g:link>
                                    </li>
                                </g:each>
                                </ul>
                            </td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" style="text-align: left;" class="value">
                                <g:link controller="message" action="list" id="${tekEventInstance.id}"> View Messages
                                </g:link>
                            </td>
